...
{
    internal static class TwoStoryShip_AllWindows
    {
        public static PosterData[] Get() => new PosterData[]
        {
            new() { Position = new Vector3(10.1567f, 2.75f, -8.8293f), Rotation = new Vector3(0, 0, 0), Scale = new Vector3(0.6391f, 0.4882f, 2f), Name = "Poster1" },
            ...
            new() { Position = new Vector3(5.4549f, 2.8195f, -17.3266f), Rotation = new Vector3(0, 200.8318f, 359.8f), Scale = new Vector3(0.5516f, 0.769f, 1f), Name = "Poster5" },
