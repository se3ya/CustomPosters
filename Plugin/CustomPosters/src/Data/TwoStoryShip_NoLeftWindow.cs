...
namespace CustomPosters.Data.PosterLayouts
{
    internal static class TwoStoryShip_NoLeftWindow
    {
        ...
        {
            new() { Position = new Vector3(9.8324f, 2.9318f, -8.8257f), Rotation = new Vector3(0, 0, 0), Scale = new Vector3(0.6391f, 0.4882f, 2f), Name = "Poster1" },
            new() { Position = new Vector3(7.3648f, 2.4776f, -8.8229f), Rotation = new Vector3(0, 0, 0), Scale = new Vector3(0.7296f, 0.4896f, 1f), Name = "Poster2" },
            ...
            new() { Position = new Vector3(6.1473f, 2.8195f, -17.4729f), Rotation = new Vector3(0, 179.7123f, 359.8f), Scale = new Vector3(0.5516f, 0.769f, 1f), Name = "Poster5" },
