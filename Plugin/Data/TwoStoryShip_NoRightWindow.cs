...
{
    internal static class TwoStoryShip_NoRightWindow
    {
        public static PosterData[] Get() => new PosterData[]
        {
            ...
            new() { Position = new Vector3(5.3599f, 2.5963f, -9.455f), Rotation = new Vector3(0, 307.2657f, 0), Scale = new Vector3(0.7289f, 0.9989f, 1f), Name = "Poster4" },
